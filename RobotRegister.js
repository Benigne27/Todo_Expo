...
const images = require('./assets/RegisterRobot.jpeg');

export default function RobotRegister() {
  return (
    ...
    <View style={styles.container}>
      <StatusBar style="auto" />
        ...
        <View style={styles.body}>
            ...
            <View>
              <Text style={{fontSize:35, marginTop:20, textAlign:'center', fontWeight:'bold'}}>Register</Text>
              </View>
          ...
          left={<TextInput.Icon size={20} style={{backgroundColor:'#F4D9D0'}} icon={'account-outline'} color={'#F3B872'}/>}/>
        </View>
        <View style={styles.email}>
          <TextInput style={styles.email1} label='Email'
          mode='flat' underlineColor='rgba(128, 128, 128, 0.1)' theme={{roundness:30}}
          left={<TextInput.Icon size={20} style={{backgroundColor:'#FCD0FF'}} icon={'email-outline'} color={'#BA61CD'}/>}/>
        </View>
        <View style={styles.email}>
      ...
      <View style={{display:'flex', flexDirection:'row', gap:50, marginTop:50}}>
        ...
        <Icon name='google' type='font-awesome' iconStyle={{backgroundColor:'white', padding:10, fontSize:40, borderRadius:40, color:'red'}}/>
        <Icon name='apple' iconStyle={{fontSize:40, backgroundColor:'white', padding:10, borderRadius:40}}/>
      </View>
      </View>
        </View>
    </View>
